                    ...
                    <div id="chat-messages" class="chat-messages">
                        <div class="chat-message">
                            <div class="sender pull-left">
                                <div class="icon">
                                    <img src="img/avatars/2.png" class="img-circle" alt="">
                                </div>
                                <div class="time">
                                    4 min
                                </div>
                        ...
                        <div class="chat-message">
                            <div class="sender pull-right">
                                <div class="icon">
                                    <img src="img/avatars/5.png" class="img-circle" alt="">
                                </div>
                                <div class="time">
                                    3 min
                                </div>
                        ...
                        <div class="chat-message">
                            ...
                            <div class="chat-message-body">
                                ...
                                <div class="sender"><a href="#">Tikhon Laninga</a></div>
                                <div class="text">
                                    Any chance to go out? To take a trivial example, which of us ever
                                    undertakes
                        ...
                        <div class="chat-message">
                            ...
                            <div class="chat-message-body on-left">
                                ...
                                <div class="sender"><a href="#">Cenhelm Houston</a></div>
                                <div class="text">
                                    .. Maybe 40-50 mins. I don't know exactly. On the other hand, we
                                    denounce
                    ...
                    <div class="wrapper">
                        ...
                        <section class="feed-item">
                            ...
                            <div class="feed-item-body">
                                <div class="text">
                                    <a href="#">John Doe</a> commented on <a href="#">What Makes Good Code
                                        Good</a>.
                                </div>
                        ...
                        <section class="feed-item">
                            <div class="icon pull-left">
                                <img src="img/avatars/1.png" class="img-circle" alt="">
                            </div>
                            <div class="feed-item-body">
                                <div class="text">
                        ...
                        <section class="feed-item">
                            ...
                            <div class="feed-item-body">
                                <div class="text">
                                    Server fail level raises above normal. <a href="#">See logs</a> for
                                    details.
                                </div>
                                <div class="time pull-left">
                                    Yesterday
        ...
        <section class="widget widget-tabs">
            ...
            <div class="body tab-content">
                <div id="stats" class="tab-pane active clearfix">
                    ...
                    <ul class="news-list">
                        <li>
                            <img src="img/avatars/1.png" alt="" class="pull-left img-circle" />
                        ...
                        <li>
                            <img src="img/avatars/2.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                        ...
                        <li>
                            <img src="img/avatars/3.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                        ...
                        <li>
                            <img src="img/avatars/4.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                        ...
                        <li>
                            <img src="img/avatars/5.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                ...
                <div id="report" class="tab-pane">
                    ...
                    <ul class="news-list news-list-no-hover">
                        <li>
                            <img src="img/avatars/6.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                                <div class="name"><a href="#">Jessica Johnsson</a></div>
                                <div class="options">
                        ...
                        <li>
                            <img src="img/avatars/7.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                                <div class="name"><a href="#">Frans Garey</a></div>
                                <div class="options">
                                    <button class="btn btn-xs btn-success mr-md">
